...
(function ($) {
  ...
  $.fn.numericInput = function (options) {
    ...
    this.keypress(function (event) {
      ...
      {
        inputChar = String.fromCharCode(inputCode); //convert value
        if (allowFloat == true && decimalPoint == inputChar)  // Conditions for a period (decimal point)
        {
          //Disallows a period before a negative
          if (allowNegative == true && getCaret(this) == 0 && currentValue.charAt(0) == '-')
            return false;
          
          var regex = new RegExp("[" + decimalPoint + "]");
